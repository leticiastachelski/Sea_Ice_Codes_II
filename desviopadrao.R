...
#---- ABRINDO ARQUIVOS
i1 <- read.table("/home/leticia/Documentos/leticia_dados_CMIP/dados_CMIP5/desvio padrão/desvio_padrao_gfdl.txt") 
i2 <- read.table("/home/leticia/Documentos/leticia_dados_CMIP/dados_CMIP5/desvio padrão/desvio_padrao_mpi.txt")
i3 <- read.table("/home/leticia/Documentos/leticia_dados_CMIP/dados_CMIP5/desvio padrão/desvio_padrao_ncar.txt")
i4 <- read.table("/home/leticia/Documentos/leticia_dados_CMIP/dados_CMIP6/desvio padrão/desvio_padrao_gfdl.txt")
i5 <- read.table("/home/leticia/Documentos/leticia_dados_CMIP/dados_CMIP6/desvio padrão/desvio_padrao_mpi.txt")
i6 <- read.table("/home/leticia/Documentos/leticia_dados_CMIP/dados_CMIP6/desvio padrão/desvio_padrao_ncar.txt")
...
i9 <- read.table("/home/leticia/Documentos/leticia_dados_CMIP/satelite/Sate HadISST_ICE/sate_desviopadrao.txt")
## ----------------------------------------
j <- read.table("/home/leticia/Documentos/leticia_dados_CMIP/dados_CMIP5/desvio padrão/desvio_padrao_access.txt")
j1 <- read.table("/home/leticia/Documentos/leticia_dados_CMIP/dados_CMIP6/desvio padrão/desvio_padrao_access.txt")
j2 <- read.table("/home/leticia/Documentos/leticia_dados_CMIP/dados_CMIP5/desvio padrão/desvio_padrao_canesm.txt")
j3 <- read.table("/home/leticia/Documentos/leticia_dados_CMIP/dados_CMIP6/desvio padrão/desvio_padrao_canesm.txt")
j4 <- read.table("/home/leticia/Documentos/leticia_dados_CMIP/dados_CMIP5/desvio padrão/desvio_padrao_fgoals.txt")
j5 <- read.table("/home/leticia/Documentos/leticia_dados_CMIP/dados_CMIP6/desvio padrão/desvio_padrao_fgoals.txt")
j6 <- read.table("/home/leticia/Documentos/leticia_dados_CMIP/dados_CMIP5/desvio padrão/desvio_padrao_ipsl.txt")
j7 <- read.table("/home/leticia/Documentos/leticia_dados_CMIP/dados_CMIP6/desvio padrão/desvio_padrao_ipsl.txt")
j8 <- read.table("/home/leticia/Documentos/leticia_dados_CMIP/dados_CMIP5/desvio padrão/desvio_padrao_miroc.txt")
j9 <- read.table("/home/leticia/Documentos/leticia_dados_CMIP/dados_CMIP6/desvio padrão/desvio_padrao_miroc.txt")
j10 <- read.table("/home/leticia/Documentos/leticia_dados_CMIP/dados_CMIP5/desvio padrão/desvio_padrao_earth.txt")
j11 <- read.table("/home/leticia/Documentos/leticia_dados_CMIP/dados_CMIP6/desvio padrão/desvio_padrao_earth.txt")
j12 <- read.table("/home/leticia/Documentos/leticia_dados_CMIP/dados_CMIP5/desvio padrão/desvio_padrao_giss.txt")
j13 <- read.table("/home/leticia/Documentos/leticia_dados_CMIP/dados_CMIP6/desvio padrão/desvio_padrao_giss.txt")
j14 <- read.table("/home/leticia/Documentos/leticia_dados_CMIP/dados_CMIP5/desvio padrão/desvio_padrao_hadgem.txt")
j15 <- read.table("/home/leticia/Documentos/leticia_dados_CMIP/dados_CMIP6/desvio padrão/desvio_padrao_hadgem.txt")
## ----------------------------------------
...
#  geom_line(aes(x=mes,y=CMIP6, colour= "CMIP6 mean",linetype= "CMIP6 mean"),size=1)+
  geom_line(aes(x=mes,y=SATE, colour= "Satellite",linetype= "Satellite"),size=1)+
